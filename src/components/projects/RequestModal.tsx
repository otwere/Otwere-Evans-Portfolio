...
export const RequestModal = ({ isOpen, project, onClose }: RequestModalProps) => {
    ...
    return (
        ...
        >
            <div className="flex h-full sm:min-h-full items-center justify-center p-0 sm:p-4">
                <div
                    className="relative w-full h-full sm:h-auto max-w-3xl rounded-none sm:rounded-xl bg-white border-0 sm:border border-slate-200 animate-slideUp shadow-none sm:shadow-sm flex flex-col sm:max-h-[90vh]"
