              ...
              <svg className="absolute h-0 w-0">
                <defs>
                  <linearGradient id="grad1" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#6f71f3ff', stopOpacity: 0.95 }} />
                    <stop offset="100%" style={{ stopColor: '#8b5cf6', stopOpacity: 0.95 }} />
                  </linearGradient>
                  <linearGradient id="grad2" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#3b82f6', stopOpacity: 0.95 }} />
                    <stop offset="100%" style={{ stopColor: '#54bbebff', stopOpacity: 0.95 }} />
                  </linearGradient>
                  <linearGradient id="grad3" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#f54c68ff', stopOpacity: 0.95 }} />
                    <stop offset="100%" style={{ stopColor: '#f570acff', stopOpacity: 0.95 }} />
                  </linearGradient>
                  <linearGradient id="grad4" x1="0%" y1="0%" x2="100%" y2="100%">
                    <stop offset="0%" style={{ stopColor: '#f97316', stopOpacity: 0.95 }} />
                    <stop offset="100%" style={{ stopColor: '#f19868ff', stopOpacity: 0.95 }} />
                  </linearGradient>
                </defs>
              </svg>
